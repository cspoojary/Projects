...
## 🎯 Objective
To build and evaluate a regression model that predicts house prices
...
## 📈 Results
- R² Score: **-0.0067**
- The negative R² score indicates weak linear relationships
...
- “Why is R² negative?”
  - The ML pipeline is correct, but the dataset has weak linear relationships.
  - This project focuses on understanding regression, evaluation metrics, and visualization rather than maximizing accuracy.”
...
## 📌 Conclusion
The Linear Regression model was successfully implemented and evaluated.
